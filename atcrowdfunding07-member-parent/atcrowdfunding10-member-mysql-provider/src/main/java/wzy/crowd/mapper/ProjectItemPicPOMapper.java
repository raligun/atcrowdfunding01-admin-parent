...
import wzy.crowd.entity.po.ProjectItemPicPO;
import wzy.crowd.entity.po.ProjectItemPicPOExample;
...
public interface ProjectItemPicPOMapper {
    ...
    int insertBatch(@Param("projectId") Integer projectId, @Param("itemPicPathList") List<String> itemPicPathList);
}